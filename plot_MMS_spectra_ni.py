...
iondir = r'/home/sohom/MMS/MMS_DATA/ascii/20160124/233614/ions'

df1 = pd.read_csv(os.path.join(iondir, r'Ni_1_resNi_1.dat'), delim_whitespace = True, names = ['Datetime', 'ni'])
